# Paint circle (mm) (rgb)
#
# Command that emulates Paint circle (mm)..., but where the colour argument
...
form Paint circle (mm) (rgb)
  ...
  real Centre_x: 0.0
  real Centre_y: 0.0
  real Diameter_(mm): 30.0
endform

@rgb2praat: red, green, blue
Paint circle (mm): rgb2praat.color$, centre_x, centre_y, diameter
