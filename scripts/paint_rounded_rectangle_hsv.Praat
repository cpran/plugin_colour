...
# argument is provided in an HSV format. Hue has to be entered as an integer
# from 1 to 360. Saturation and value have to be entered as integers from 1
# to 100.
#
...
Paint rounded rectangle: hsv2praat.color$, from_x, to_x, from_y, to_y, radius
